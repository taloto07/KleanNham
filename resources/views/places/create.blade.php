      	...
      	<fieldset>
	    	<legend>Basic Information</legend>
		  	<div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
				...
				{{ Form::select('tags[]', $tags, null, ['class' => 'form-control tags', 'multiple' => 'multiple', 'aria-describedby' => 'tagsErrorMessage', 'style' => 'width: 100%']) }}
			...
			<div class="row">
    			...
    			<div class="col-md-6">
      				<div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
						...
						{{ Form::text('address', null, ['class' => 'form-control', 'aria-describedby' => 'addressErrorMessage', "placeholder" => "Address", 'id' => 'address']) }}
      				...
      				<div class="form-group {{ $errors->has('latitude') ? 'has-error' : '' }}">
						...
						{{ Form::text('latitude', null, ['class' => 'form-control', 'id' => 'latitude', 'aria-describedby' => 'latitudeErrorMessage']) }}	
      				...
      				<div class="form-group {{ $errors->has('longitude') ? 'has-error' : '' }}">
						...
						{{ Form::text('longitude', null, ['class' => 'form-control', 'id' => 'longitude', 'aria-describedby' => 'longitudeErrorMessage']) }}
      				...
      				<div class="form-group {{ $errors->has('sangkat') ? 'has-error' : '' }}">
						...
						{{ Form::select('sangkat', $sangkats, null, ['class' => 'form-control sangkat', 'aria-describedby' => 'sangkatErrorMessage', 'placeholder' => 'Pick sangkat', 'style' => 'width: 100%']) }}
      				...
      				<div class="form-group {{ $errors->has('khan') ? 'has-error' : '' }}">
							...
							{{ Form::select('khan', $khans, null, ['class' => 'form-control khan1', 'aria-describedby' => 'khanErrorMessage', 'placeholder' => 'Pick khan', 'id' => 'khan', 'style' => 'width: 100%']) }}
      				...
      				<div class="form-group {{ $errors->has('city') ? 'has-error' : '' }}">
							...
							{{ Form::text('city', 'Phnom Penh', ['id' => 'city', 'class' => 'form-control khan', 'aria-describedby' => 'cityErrorMessage', 'readonly']) }}
  			...
  			<div class="row">
    			<div class="col-sm-4">
      				<div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
    					{{ Form::label('email', 'Email', ['class' => 'control-label'] ) }}
                        	{{ Form::text('email', null, ['class' => 'form-control', 'aria-describedby' => 'emailErrorMessage']) }}
    			...
    			<div class="col-sm-4">
      				<div class="form-group {{ $errors->has('website') ? 'has-error' : '' }}">
    					{{ Form::label('website', 'Website', ['class' => 'control-label'] ) }}
	                        {{ Form::text('website', null, ['class' => 'form-control', 'aria-describedby' => 'websiteErrorMessage']) }}
    			...
    			<div class="col-sm-4">
      				<div class="form-group {{ $errors->has('facebook') ? 'has-error' : '' }}">
                      	...
                      	{{ Form::text('facebook', null, ['class' => 'form-control', 'aria-describedby' => 'facebookErrorMessage']) }}
    			...
    			<div class="col-sm-4">
      				<div class="form-group {{ $errors->has('phones.0') ? 'has-error' : '' }}">
      					<label>Phone</label>
      					<input type="number" name="phones[]" class="form-control" aria-describedby="phone1ErrorMessage" value="{{ old('phones.0') }}">
    			...
    			<div class="col-sm-4">
      				<div class="form-group {{ $errors->has('phones.1') ? 'has-error' : '' }}">
      					<label>Phone</label>
      					<input type="number" name="phones[]" class="form-control" aria-describedby="phonesErrorMessage" value="{{ old('phones.1') }}">
    			...
    			<div class="col-sm-4">
      				<div class="form-group {{ $errors->has('phones.2') ? 'has-error' : '' }}">
        					<label>Phone</label>
        					<input type="number" name="phones[]" class="form-control" aria-describedby="phonesErrorMessage" value="{{ old('phones.2') }}">
