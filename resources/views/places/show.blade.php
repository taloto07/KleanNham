                    ...
                    <span data-toggle="tooltip" data-placement="top" title="{{ $place->price->description }}">
                  	...
                  	<ul class="social">
                        @if ( !is_null($place->contact->facebook) )
                            <li><a href="{{$place->contact->facebook}}" target="_blank"><i class="fa fa-facebook"></i></a></li>
                        @endif
                    ...
                    <div class="box-inner">
                        <div class="overview overview-half overview-no-margin">
                          <ul>
                            ...
                            <li><strong>Website</strong><span><a href="{{ $place->contact->website }}" target="_blank">{{ $place->contact->website }}</a></span></li>
                            <li><strong>Facebook</strong><span><a href="{{ $place->contact->facebook }}" target="_blank">{{ $place->contact->facebook }}</a></span></li>
                            <li>
                                <strong>Price</strong>
                                <span data-toggle="tooltip" data-placement="top" title="{{ $place->price->description }}">
                                    @for($i = $place->price->amount; $i > 0; $i--)
